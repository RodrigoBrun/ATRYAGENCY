...
Esta versión agrega una capa emocional y humana sin convertir el Playground en
un chatbot ni bloquear la exploración.

### Incluye

- Bienvenida opcional en la primera visita.
- Tres recorridos sugeridos:
  - Tengo una marca.
  - Tengo una idea.
  - Solo vengo a jugar.
- Guía contextual con mensajes breves y humanos.
- Recomendación visual del mejor módulo para comenzar.
- Panel al final de cada experimento para guardar una intuición.
- Traspaso de esa intuición al formulario de contacto.
- Microcelebraciones visuales y vibración ligera compatible con móvil.
...
```text
assets/playground/contact-bridge.js
```

lee el brief guardado desde el Playground y completa el mensaje del formulario
de la Home.

Para usarlo en otra versión de `index.html`, agregar antes de `</head>`:

```html
<script src="assets/playground/contact-bridge.js" defer></script>
```
